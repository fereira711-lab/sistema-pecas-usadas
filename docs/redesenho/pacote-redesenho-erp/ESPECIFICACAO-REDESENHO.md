...
40. **Detalhes da origem:** "Resultado da origem" = recuperado − valor pago (a mesma conta do Painel, decisão 6). Cálculo em `financeiro-utils.calcularRetornoOrigem`, com teste. "Ainda em estoque" em unidades, como no Painel.
